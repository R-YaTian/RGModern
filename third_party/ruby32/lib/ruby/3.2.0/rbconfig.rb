...
module RbConfig
  RUBY_VERSION.start_with?("3.2.") or
    raise "ruby lib version (3.2.8) doesn't match executable version (#{RUBY_VERSION})"

  # Ruby installed directory.
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.2.0/i386-mswin32_140")
  ...
  CONFIG["MINOR"] = "2"
  CONFIG["TEENY"] = "8"
  CONFIG["PATCHLEVEL"] = "263"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "C:/ruby32")
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["ruby_install_name"] = "ruby"
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "vcruntime140-ruby320"
  CONFIG["SHELL"] = "$(COMSPEC)"
  CONFIG["BUILD_FILE_SEPARATOR"] = "\\"
  CONFIG["PATH_SEPARATOR"] = ";"
  CONFIG["CFLAGS"] = "-MD -D_WIN32_WINNT=0x0501 -D_USING_V110_SDK71_ -Zi -W2 -wd4100 -wd4127 -wd4210 -wd4214 -wd4255 -wd4574  -wd4668 -wd4710 -wd4711 -wd4820 -wd4996  -we4028 -we4142 -we4047 -O2sy- -Zc:inline -Zm600 "
  CONFIG["WERRORFLAG"] = "-WX"
  CONFIG["DEFS"] = ""
  CONFIG["CPPFLAGS"] = " -D_WIN32_WINNT=0x0600  "
  CONFIG["CXXFLAGS"] = "-MD -D_WIN32_WINNT=0x0501 -D_USING_V110_SDK71_ -Zi -W2 -wd4100 -wd4127 -wd4210 -wd4214 -wd4255 -wd4574  -wd4668 -wd4710 -wd4711 -wd4820 -wd4996  -we4028 -we4142 -we4047 -O2sy- -Zc:inline -Zm600 "
  CONFIG["incflags"] = ""
  CONFIG["FFLAGS"] = ""
  CONFIG["LDFLAGS"] = "-incremental:no -debug -opt:ref -opt:icf"
  CONFIG["LIBS"] = "user32.lib"
  CONFIG["MAINLIBS"] = "user32.lib advapi32.lib shell32.lib ws2_32.lib ntdll.lib iphlpapi.lib imagehlp.lib shlwapi.lib bcrypt.lib "
  ...
  CONFIG["build"] = "i686-pc-mswin32_140"
  CONFIG["build_alias"] = "i686-mswin32_140"
  CONFIG["build_cpu"] = "i686"
  CONFIG["build_vendor"] = "pc"
  CONFIG["build_os"] = "mswin32_140"
  CONFIG["host"] = "$(target)"
  ...
  CONFIG["target_alias"] = "i386-mswin32_140"
  CONFIG["target_cpu"] = "i386"
  CONFIG["target_vendor"] = "pc"
  CONFIG["target_os"] = "mswin32_140"
  ...
  CONFIG["RPATHFLAG"] = ""
  CONFIG["LIBARG"] = "%s.lib"
  CONFIG["LINK_SO"] = "$(LDSHARED) -Fe$(@) $(OBJS) $(LIBS) $(LOCAL_LIBS) -link $(DLDFLAGS) -libpath:../../../extlib -implib:$(*F:.so=)-$(arch).lib -pdb:$(*F:.so=)-$(arch).pdb -def:$(DEFFILE)"
  ...
  CONFIG["TRY_LINK"] = "$(CC) -Feconftest $(INCFLAGS) -I$(hdrdir) $(CPPFLAGS) $(CFLAGS) $(src) $(LOCAL_LIBS) $(LIBS) -link $(LDFLAGS) $(LIBPATH) -libpath:../../../extlib $(XLDFLAGS)"
  ...
  CONFIG["arch"] = "i386-mswin32_140"
  CONFIG["sitearch"] = "i386-vcruntime140"
  ...
  CONFIG["configure_args"] = "--with-make-prog=nmake --enable-shared --prefix=C:/ruby32"
